...
export default function PrivacyPolicy() {
  ...
  return (
    ...
    >
      <p className="lead">
        This Privacy Notice forLaser Print Guide ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
      </p>
      <ul>
        <li>Visit our website at <a href="https://laserprintguide.co/">http://laserprintguide.co/</a> or any website of ours that links to this Privacy Notice</li>
      ...
      <p>To exercise any of these rights, please contact us by {emailLink} or by visiting <a href="https://laserprintguide.co/contact">https://laserprintguide.co/contact</a>.</p>
      <h3>Appeals</h3>
