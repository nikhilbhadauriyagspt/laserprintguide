...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        We areLaser Print Guide
 
  ("Company," "we," "us," "our"), a company registered in  United States at info@laserprintguide.co
      </p>
      <p>
  ...
  is your trusted destination for authentic, high-performance printers and printing accessories .
      ...
      <p>
        You can contact us by email at <a href="mailto:info@laserprintguide.co">info@laserprintguide.co</a>, or by mail at info@laserprintguide.co
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), andLaser Print Guide
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://laserprintguide.co/return-policy">http://laserprintguide.co/return-policy</a>.</p>
