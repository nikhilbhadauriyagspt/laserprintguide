...
export default function TermsAndConditions() {
  return (
    ...
    >
      ...
      <p>
        We are Laser Print Guide
        ("Company," "we," "us," "our"), a company registered in United States at <a href="mailto:info@laserprintguide.co" className="hover:underline text-black">info@laserprintguide.co</a>
      </p>
      <p>
      ...
      <p>
        You can contact us by email at <a href="mailto:info@laserprintguide.co" className="hover:underline text-black">info@laserprintguide.co</a>, or by mail at <a href="mailto:info@laserprintguide.co" className="hover:underline text-black">info@laserprintguide.co</a>
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Laser Print Guide
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@laserprintguide.co">info@laserprintguide.co</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <Link to="/return-policy" className="text-blue-700 hover:underline">Return Policy</Link>.</p>
      ...
      <p>We care about data privacy and security. Please review our Privacy Policy: <Link to="/privacy-policy" className="text-blue-700 hover:underline">Privacy Policy</Link>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms.
 Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase er">
          <p className="text-slate-900 font-bold">Laser Print Guide </p>
          
          <p className="pt-4 text-black font-bold lowercase">Email: <a href="mailto:info@laserprintguide.co" className="hover:underline">info@laserprintguide.co</a></p>
        </address>
      </div>
    </PolicyLayout>
  );
